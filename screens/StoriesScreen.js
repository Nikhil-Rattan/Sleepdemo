...
const bg = require('../images/bgimages/unicorn.jpg');
            ...
            <SafeAreaView style={styles.container}>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-around'}}>
                    ...
                    <TouchableOpacity style={{marginTop:'2.5%',marginRight:'3%',}}>
                        <Image source={require('../images/icons/woman.png')} style={{height:70, width:70}}/>
                        <Text style={{color:'white',fontSize:12, fontWeight:'bold',alignSelf:'center',paddingTop:'2%'}}>Female</Text> 
                        <Text style={{color:'white',fontSize:12, fontWeight:'bold',alignSelf:'center',}}>narration</Text>
                    </TouchableOpacity>
                        <TouchableOpacity style={{marginTop:'2.5%',marginRight:'3%'}}>
                        <Image source={require('../images/icons/man.png')} style={{height:70, width:70}}/>
                        <Text style={{color:'white',fontSize:12, fontWeight:'bold',alignSelf:'center',paddingTop:'2%'}}>Male narration</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{marginTop:'2.5%',marginRight:'3%'}}>
                        <Image source={require('../images/icons/girl.png')} style={{height:70, width:70}}/>
